...
public class CompraDao {
    public ArrayList<MasDetallesDto> listarDetallesCompra(int idjuego){
        ArrayList<MasDetallesDto> listaDetallesCompra = new ArrayList<>();
             ...
             PreparedStatement ptsmtCompra = connection.prepareStatement(sql))
        {
            ...
            try (ResultSet rs = ptsmtCompra.executeQuery()){
                while(rs.next()){
                    MasDetallesDto juegoCompra = new MasDetallesDto();
