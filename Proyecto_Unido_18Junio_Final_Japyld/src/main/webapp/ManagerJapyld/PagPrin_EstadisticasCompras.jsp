            ...
            <div class="card">
              <div class="card-header border-bottom">
                ...
                <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                  ...
                  <a class="nav-item nav-link active" id="wizard2-tab" href="<%=request.getContextPath()%>/ManagerServlet?a=estadisticasCompras" data-bs-toggle="tab" role="tab" aria-controls="wizard2" aria-selected="false" tabindex="-1">
                  ...
                  <a class="nav-item nav-link" id="wizard3-tab" href="<%=request.getContextPath()%>/ManagerServlet?a=estadisticasIngresos" data-bs-toggle="tab" role="tab" aria-controls="wizard3" aria-selected="true">
              ...
              <div class="card-body">
                <div class="tab-content" id="cardTabContent">
                  ...
                  <div class="tab-pane py-5 py-xl-10 fade active show" id="wizard2" role="tabpanel" aria-labelledby="wizard2-tab">
                    <div class="row justify-content-center">
                      <div class="col-xxl-6 col-xl-8">
                        <h5 class="text-primary text-center">RECORD DE JUEGOS COMPRADOS POR ADMINISTRADORES</h5>
                            ...
                            var barChart = new Chart(ctx, {
                              ...
                              data: {
                                ...
                                datasets: [{
                                  ...
                                  data: [<%=estadisticasDao.CompraPorMes("March") %>, <%=estadisticasDao.CompraPorMes("April") %>, <%=estadisticasDao.CompraPorMes("May") %>, <%=estadisticasDao.CompraPorMes("June") %>, <%=estadisticasDao.CompraPorMes("July") %>, <%=estadisticasDao.CompraPorMes("August") %>, <%=estadisticasDao.CompraPorMes("September") %>, <%=estadisticasDao.CompraPorMes("October") %>, <%=estadisticasDao.CompraPorMes("November")%>, <%=estadisticasDao.CompraPorMes("December")%>],
                                  backgroundColor: [
