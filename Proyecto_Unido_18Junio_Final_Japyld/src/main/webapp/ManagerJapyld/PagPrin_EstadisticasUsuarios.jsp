            ...
            <div class="card">
              <div class="card-header border-bottom">
                ...
                <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                  ...
                  <a class="nav-item nav-link active" id="wizard4-tab" href="<%=request.getContextPath()%>/ManagerServlet?a=estadisticasUsuarios" data-bs-toggle="tab" role="tab" aria-controls="wizard4" aria-selected="false" tabindex="-1">
              ...
              <div class="card-body">
                <div class="tab-content" id="cardTabContent">
                  ...
                  <div class="tab-pane py-5 py-xl-10 fade active show" id="wizard4" role="tabpanel" aria-labelledby="wizard4-tab">
                    <div class="row justify-content-center">
                      <div class="col-xxl-6 col-xl-8">
                        <h5 class="text-primary text-center">CANTIDAD DE USUARIOS REGISTRADOS POR MES</h5>
