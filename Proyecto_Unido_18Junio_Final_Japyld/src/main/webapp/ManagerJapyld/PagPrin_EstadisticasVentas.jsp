...
<% ArrayList<JuegosManager> mesYventas = (ArrayList<JuegosManager>) request.getAttribute("mesYventas"); %>
<html lang="en">
            ...
            <div class="card">
              <div class="card-header border-bottom">
                ...
                <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                  ...
                  <a class="nav-item nav-link active" id="wizard1-tab" href="<%=request.getContextPath()%>/ManagerServlet?a=estadisticasVentas" data-bs-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="false" tabindex="-1">
