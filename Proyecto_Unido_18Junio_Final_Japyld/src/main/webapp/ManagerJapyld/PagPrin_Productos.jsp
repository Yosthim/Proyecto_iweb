      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid" id="productos">
            ...
            <br>
            <h4 class="h5 mb-1 text-gray-800">LOS MÁS VENDIDOS</h4>
            <br>
            <div class="row">
              <!-- Earnings (Monthly) Card Example -->
              <% for  (ProductosVendidos vendido : listaMasVendidos) {%>
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                          <h6><b>📈<%=vendido.getNombreJuego()%></b></h6>
                          <br>
                        </div>
                        <img src="<%=vendido.getDireccion_archivo()%>" class="img-fluid" alt="Imagen">
                        <div class="mt-3">
                          <div class="h5 mb-0 font-weight-bold text-gray-800">Precio: S/. <%=vendido.getPrecio()%></div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <br>
            <br>
            <h4 class="h5 mb-1 text-gray-800">LOS MENOS VENDIDOS</h4>
            <br>
            <div class="row">
              <!-- Earnings (Monthly) Card Example -->
              <% for  (ProductosVendidos vendido1 : listaMenosVendidos) {%>
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                          <h6><b>📉<%=vendido1.getNombreJuego()%></b></h6>
                          <br>
                        </div>
                        <img src="<%=vendido1.getDireccion_archivo()%>" class="img-fluid" alt="Imagen">
                        <div class="mt-3">
                          <div class="h5 mb-0 font-weight-bold text-gray-800">Precio: S/. <%=vendido1.getPrecio()%></div>
                        </div>
                      </div>
                    </div>
                  </div>
