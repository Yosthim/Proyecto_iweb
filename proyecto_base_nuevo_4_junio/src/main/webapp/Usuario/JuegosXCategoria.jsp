...
<% ArrayList<PaginaprincipalJuegosBean> listaJuegosXcategoria = (ArrayList<PaginaprincipalJuegosBean>) request.getAttribute("listaJuegosXcategoria"); %>
...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
      ...
      <div class="sidebar-brand-text mx-3"><h7>Japyld</h7><sup>tm</sup></div>
    </a>
    ...
    <li class="nav-item active">
      <a class="nav-link" href="index.html">
        <div class="d-flex flex-column align-items-center">
          <h5 class="mb-0">Venta de Juegos</h5>
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <% for (PaginaprincipalJuegosBean juegos : listaJuegosXcategoria) {%>
