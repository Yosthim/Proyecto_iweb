...
<% ArrayList<MasDetallesBean> listaDetallesCompra = (ArrayList<MasDetallesBean>) request.getAttribute("listaDetallesCompra"); %>
<html>
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <% for (MasDetallesBean juegocompra : listaDetallesCompra){ %>
