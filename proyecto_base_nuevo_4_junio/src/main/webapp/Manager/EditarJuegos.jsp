...
<% ArrayList<Juegos> listarTodosJuegos = (ArrayList<Juegos>) request.getAttribute("listarTodosJuegos"); %>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            <br>
            <h1 class="h3 mb-2 text-gray-800 text-center">REVISAR Y EDITAR JUEGOS</h1>
            <br>
            <br>
            ...
            <div class="row">
              ...
              <% for (Juegos juegosTodos : listarTodosJuegos) {%>
