...
<%@ page import="com.example.proyecto_base_japyld.Manager.Models.Beans.Juegos" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<% ArrayList<Juegos> listaTop5MenosVendidos = (ArrayList<Juegos>) request.getAttribute("listaTop5MenosVendidos"); %>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <% for (Juegos juegosMenosVendidos : listaTop5MenosVendidos) {%>
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                          <h5><b><%=juegosMenosVendidos.getNombreJuegos()%></b></h5>
                          <div class="h3 mb-0 font-weight-bold text-gray-800 justify-content-center">  ⭐ </div>
                        </div>
                        <img src="<%=juegosMenosVendidos.getDireccion_imagen()%>" class="img-fluid" alt="Imagen">
                        <div class="mt-3">
