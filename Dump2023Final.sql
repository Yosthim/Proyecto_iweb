...
INSERT INTO `comentarios` VALUES (1,'Los gráficos y la jugabilidad son increíbles, pero la trama podría haber sido más profunda.',4,12,2),(2,'Los escenarios son impresionantes y las secuencias de acción son emocionantes, aunque la duración del juego podría haber sido un poco más larga.',5,12,4),(3,'La exploración de los entornos es fascinante y los personajes tienen una gran profundidad, pero algunos de los rompecabezas podrían haber sido más desafiantes. ',4,12,6),(4,'El concepto del juego es interesante, pero la ejecución carece de originalidad y la jugabilidad se vuelve repetitiva rápidamente.',3,6,8),(5,'El diseño visual es atractivo, pero la falta de profundidad en la mecánica de juego y la falta de contenido adicional hacen que la experiencia sea mediocre.',3,6,9),(6,'Mirror Forge tiene potencial con su sistema de creación de espejos, pero la falta de variedad en los desafíos y la falta de una narrativa convincente hacen que pierda su atractivo rápidamente.',2,6,7),(7,'Elden Ring es una obra maestra del género de acción y rol. Su vasto mundo abierto, combate desafiante y narrativa profunda se combinan para ofrecer una experiencia de juego inolvidable. Con su impresionante diseño artístico y una jugabilidad envolvente, es simplemente perfecto.',5,4,7),(8,'Elden Ring redefine los límites del género con su inmersiva y vasta exploración. La atención al detalle en cada aspecto del juego, desde la narrativa hasta los combates épicos, es excepcional. Una experiencia sin igual que merece el reconocimiento completo.',5,4,4),(9,'Elden Ring es un logro magistral en el mundo de los videojuegos. La combinación perfecta de desafío, ambientación y narrativa envuelve al jugador en un viaje épico lleno de misterios y descubrimientos. Cada aspecto, desde el diseño de niveles hasta la banda sonora, está cuidadosamente elaborado para brindar una experiencia inigualable.',5,4,6);
...
INSERT INTO `objetivosmanager` VALUES (1,200.00,150.00,10,10,'2023-07-01');
...
-- Dump completed on 2023-06-13 12:24:55
